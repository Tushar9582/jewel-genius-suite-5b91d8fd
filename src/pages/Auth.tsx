...
export default function Auth() {
  ...
  const validateEmployeeForm = () => {
    try {
      ...
      if (error instanceof z.ZodError) {
        const fieldErrors: { employee_id?: string; password?: string } = {};
        error.errors.forEach((err) => {
          if (err.path[0] === 'employee_id') fieldErrors.employee_id = err.message;
          if (err.path[0] === 'password') fieldErrors.password = err.message;
        });
        setErrors(fieldErrors);
      }
        ...
        <CardContent>
          ...
          <div className="flex gap-2 mb-6">
            <Button
              ...
              className={`flex-1 ${loginType === 'admin' ? 'bg-gradient-gold hover:opacity-90' : ''}`}
            ...
            <Button
              ...
              className={`flex-1 ${loginType === 'employee' ? 'bg-gradient-gold hover:opacity-90' : ''}`}
          ...
          {loginType === 'admin' ? (
            ...
            <form onSubmit={handleEmployeeSignIn} className="space-y-4">
              ...
              <p className="text-xs text-center text-muted-foreground mt-4">
                Employee accounts are created by the administrator. Contact your admin if you don't have an account.
              </p>
            </form>
          )}
        </CardContent>
